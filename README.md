...
| 你的系统 | 下载哪个 | 怎么装 |
|---|---|---|
| macOS（Apple 芯片） | `DeepSeek.Harness-0.12.0-arm64.dmg` | 打开 dmg，把应用拖进「应用程序」文件夹 |
| macOS（Intel） | `DeepSeek.Harness-0.12.0.dmg` | 同上 |
| Windows | `DeepSeek.Harness.Setup.0.12.0.exe` | 双击安装，一路下一步 |
